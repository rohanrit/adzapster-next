...
const shapes = [
  ...
  { type: 'pyramid', size: 50, color: 'orange', position: { top: '15%', right: '15%' }, depth: 0.3, rotate: { x: -15, y: 25 } },
  ...
  { type: 'pyramid', size: 40, color: 'purple', position: { top: '70%', right: '8%' }, depth: 0.18, rotate: { x: 5, y: 35 } },
  { type: 'cube', size: 35, color: 'orange', position: { bottom: '40%', right: '20%' }, depth: 0.22, rotate: { x: -20, y: 15 } },
  ...
  { type: 'cube', size: 25, color: 'purple', position: { bottom: '50%', left: '25%' }, depth: 0.15, rotate: { x: 15, y: -25 } },
  { type: 'donut', size: 35, thickness: 5, color: 'orange', position: { top: '20%', right: '10%' }, depth: 0.18, rotate: { x: 25, z: 30 } },
  { type: 'pyramid', size: 28, color: 'orange', position: { bottom: '55%', right: '12%' }, depth: 0.1, rotate: { x: 10, y: -15 } },
