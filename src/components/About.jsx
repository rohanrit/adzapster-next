...
const shapes = [
  { type: 'cube', size: 70, color: 'blue', position: { top: '8%', right: '5%' }, depth: 0.3, rotate: { x: 20, y: -25 } },
  { type: 'donut', size: 100, thickness: 15, color: 'orange', position: { bottom: '10%', left: '4%' }, depth: 0.5, rotate: { x: 50, z: 40 } },
  { type: 'pyramid', size: 60, color: 'purple', position: { top: '60%', right: '8%' }, depth: 0.4, rotate: { x: -12, y: 30 } },
  { type: 'cube', size: 45, color: 'orange', position: { top: '15%', left: '12%' }, depth: 0.25, rotate: { x: -15, y: 40 } },
  { type: 'donut', size: 60, thickness: 10, color: 'purple', position: { top: '25%', right: '15%' }, depth: 0.35, rotate: { x: 30, z: 20 } },
  { type: 'pyramid', size: 40, color: 'blue', position: { bottom: '20%', left: '15%' }, depth: 0.3, rotate: { x: 10, y: -20 } },
  { type: 'cube', size: 35, color: 'purple', position: { top: '40%', right: '25%' }, depth: 0.2, rotate: { x: -25, y: 15 } },
  { type: 'donut', size: 50, thickness: 8, color: 'orange', position: { bottom: '30%', right: '10%' }, depth: 0.4, rotate: { x: 45, z: 30 } },
  { type: 'pyramid', size: 55, color: 'orange', position: { top: '5%', right: '20%' }, depth: 0.15, rotate: { x: 5, y: 25 } },
  { type: 'cube', size: 25, color: 'blue', position: { top: '70%', right: '30%' }, depth: 0.18, rotate: { x: -10, y: 30 } },
  { type: 'donut', size: 40, thickness: 6, color: 'blue', position: { bottom: '40%', left: '8%' }, depth: 0.22, rotate: { x: 20, z: 15 } },
  { type: 'pyramid', size: 30, color: 'purple', position: { top: '80%', right: '15%' }, depth: 0.12, rotate: { x: 15, y: -25 } },
  { type: 'cube', size: 28, color: 'orange', position: { bottom: '50%', right: '25%' }, depth: 0.1, rotate: { x: -20, y: 20 } },
  { type: 'donut', size: 35, thickness: 5, color: 'purple', position: { top: '35%', left: '20%' }, depth: 0.18, rotate: { x: 25, z: 35 } },
  { type: 'pyramid', size: 25, color: 'blue', position: { bottom: '60%', right: '18%' }, depth: 0.08, rotate: { x: 10, y: 15 } },
]
