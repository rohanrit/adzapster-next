    ...
    <>
      <Navbar />
       <main>
        ...
        {/* Leadership Team, as landing-page section */}
        <section className="section mt-20">
          <div className="container relative z-10">
            <div className="section-header flex flex-col md:flex-row justify-between items-end mb-lg gap-md">
        ...
        {/* CTA Section styled like homepage CTA block */}
