...
const legalShapes = [
  { type: 'cube', size: 45, color: 'purple', position: { top: '12%', right: '10%' }, depth: 0.3, rotate: { x: -15, y: 40 } },
  { type: 'donut', size: 65, thickness: 10, color: 'orange', position: { bottom: '25%', left: '8%' }, depth: 0.5, rotate: { x: 50, z: 40 } },
